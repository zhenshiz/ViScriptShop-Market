...
public class Config {
    ...
    public static final ModConfigSpec.IntValue MIN_PRICE;
    public static final ModConfigSpec.IntValue MAX_PRICE;
    ...
    static {
        ...
        // 商品允许设置的最低单价。
        MIN_PRICE = CONFIG_BUILDER.defineInRange("minPrice", 1, 1, Integer.MAX_VALUE);

        // 商品允许设置的最高单价。
        MAX_PRICE = CONFIG_BUILDER.defineInRange("maxPrice", 1_000_000_000, 1, Integer.MAX_VALUE);
